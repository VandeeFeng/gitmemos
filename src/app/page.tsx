...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#22272e] transition-colors duration-500">
      <div className={`fixed top-0 left-0 right-0 bg-white/80 dark:bg-[#22272e]/80 backdrop-blur-sm z-50 transition-opacity ${!mounted ? 'opacity-0' : 'opacity-100'}`}>
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <header className="flex items-center justify-between py-4">
            ...
            <div className="flex items-center gap-4">
              {mounted && <SearchBar onSearch={handleSearch} issues={issues} />}
              <Button 
